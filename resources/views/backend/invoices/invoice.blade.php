	...
	<div>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="gry-color small">{{ $shipping_address->address }}, {{ $shipping_address->area }}, {{ $shipping_address->city }}, {{ $shipping_address->state }}, {{ $shipping_address->postal_code }}</td></tr>
