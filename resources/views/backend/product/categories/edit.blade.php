            ...
            <div class="col-md-12 mb-4 mb-md-0">
                ...
                <hr>
                    <div class="card-body" style="padding-top:0px">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="basic-default">{{translate('Ordering Number')}}</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="meta_title" value="{{ $category->meta_title }}" placeholder="{{translate('Meta Title')}}" required="">
                        </div>
