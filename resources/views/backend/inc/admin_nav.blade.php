<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
      ...
      <i class="fas fa-search bx-sm position-absolute start-0 top-50 px-3"></i><input class="form-control bg-soft-secondary border-0 form-control-sm text-white" type="text" name="" placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()">
            </div>
