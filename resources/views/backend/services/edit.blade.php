...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('services.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="name" placeholder="{{translate('Service Name')}}" value="{{ $product->getTranslation('name', $lang) }}" required>
                            </div>
                        </div>
...
<!--                <div class="card">
            ...
            <div class="col-12">
                <div class="mb-3 text-right">
                    <button type="submit" name="button" class="btn btn-info">{{ translate('Update Service') }}</button>
                </div>
            </div>
        </div>
    </form>
