...
<div class="add-new-style">
    <form class="form form-horizontal mar-top" action="{{route('services.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Service Name')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" placeholder="{{ translate('Service Name') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Service Variation')}}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div>
                            <p>{{ translate('Choose the attributes of this service and then input values of each attribute') }}</p>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Service Overview')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
...
<!--                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Service Shipping Cost')}}</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-6 col-from-label">{{translate('Is Service Quantity Mulitiply')}}</label>
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        @else
                        <p>
                            {{ translate('Service wise shipping cost is disable. Shipping cost is configured from here') }}
