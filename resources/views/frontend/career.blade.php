...
@section('content')
    ...
    <section class="pageTitle">  <div class="container">   </div>  </section>
	  ...
	  <div class="row">
		 ...
		 <div class="col-md-8">
		  <form class="bottom-form" method="post" action="submitcareerform" enctype="multipart/form-data">
         @csrf
		   <div class="border-bottom1 border-color-111 mt-0 mb-3">
                  <h3 class="section-title section-title__sm mb-0 pt-2 pb-0 mt-0 font-size-18">Life @Ebuild Bazaar</h3>
                  <div class="deals">
                     <hr>
                  </div>
				   <p>  
                                       ...
                                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                          <div class="main-parenttttttT">
                                             <div class="input-group mb-3 ">
                                                ...
                                                <input type="text" name="fullname" class="form-control empty" placeholder="Full Name" />
                                             </div>
                                             ...
                                             <div class="input-group w-440 float-left mb-3">
                                                ...
                                                <input type="tel" name="phoneno" class="form-control empty" placeholder="Phone Number" />
                                             </div>
