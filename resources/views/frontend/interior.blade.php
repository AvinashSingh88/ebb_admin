            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <form class="bottom-form_contact " method="post" action="addinteriorformdata">
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="form_type" value="interior_exterior_page">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="container">
        ...
        <div class="row photos my-3">
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="./img/interior/Interior-Styling.png" data-lightbox="photos" class="lb_all-link">
              <img class="img-fluid" src="{{ url('assets/img/Interior-Styling.png')}}"/>
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="./img/interior/Interior-Styling.png" data-lightbox="photos" class="lb_all-link">
