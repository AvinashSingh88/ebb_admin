...
@section('title')Material Supplier @endsection
        ...
        <div class="row">
          ...
          <form class="bottom-form_contact " method="post" action="addinteriorformdata">
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="form_type" value="material_suplier_page">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="content_row row">
          ...
          <div class="col-md-12">
            <div class="clm_66">
              <div class="aboutIfo">
                <div class="border-bottom1 border-color-111 mt-0 mb-3">
                  <h2>Material <strong>Suppliers</strong></h2>
                  <div class="deals">
                    <hr />
                  </div>
                </div>
  ...
  <section class="four_card-section  mt-4 lightbox-gallery mb-5">
    <div class="container">
      <div class="row">
        ...
        <div class="aboutIfo">
          <div class="border-bottom1 border-color-111 mt-0 mb-3">
            <h2>Supplying Every Material Suppliers<strong>  Material</strong> All Over The Place's</h2>
            <div class="deals">
              <hr>
            </div>
          </div>
