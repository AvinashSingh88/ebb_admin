		 ...
		 <div class="col-md-12 breadmcrumsize">
		  ...
		  @else
			  <li class="breadcrumb-item"><a href="{{ route('search') }}">{{ translate('All Categories')}} </a></li>
			   @endif
                            @if(isset($category_id))
								<li class="breadcrumb-item active"><a href="{{ route('products.category', \App\Models\Category::find($category_id)->slug) }}">{{ \App\Models\Category::find($category_id)->getTranslation('name') }}</a></li>
...
@endforeach
						 ...
						 <li class="listing-botoms">
							...
							@else
									...
									<li><a class="dropdown-item1" href="{{ route('search') }}">{{ translate('All Categories')}}</a></li>
								
								@if (\App\Models\Category::find($category_id)->parent_id != 0)
									<li><a class="dropdown-item1" href="{{ route('products.category', \App\Models\Category::find(\App\Models\Category::find($category_id)->parent_id)->slug) }}">{{ \App\Models\Category::find(\App\Models\Category::find($category_id)->parent_id)->getTranslation('name') }}</a></li>
								 @endif
								 <li>
		...
		<div id="accordion" class="accordion-container contentsarround">
				<article class="content-entry open">
				 <h4 class="font-size-14 mb-3 font-weight-bold article-title">Brands  <i></i></h4>
                        ...
                        <div class="collapses" id="collapseBrand1">
                           @foreach (\App\Models\Brand::orderBy('id', 'desc')->take(50)->skip(2)->get() as $brand)							
                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input name="brand" onchange="filter()" value="{{ $brand->slug }}" type="checkbox" class="custom-control-input" id="brand{{$brand->id}}" @isset($brand_id) @if ($brand_id == $brand->id) checked @endif @endisset>
                              <label class="custom-control-label" for="brand{{$brand->id}}">{{ $brand->getTranslation('name') }} 
			...
			@foreach ($attributes as $attribute)
				<article class="content-entry">
				 <h4 class="font-size-14 mb-3 font-weight-bold article-title">{{ translate('Filter by') }} {{ $attribute->getTranslation('name') }}  <i></i></h4>
						<div class="accordion-content">
							<div class="border-topsd">
							  <div class="border-bott"> 
                        <!-- Checkboxes -->
                        ...
                        <div class="collapses5" id="collapseBrand1">
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_29">
                                 <label class="custom-control-label" for="checkbox_29">Water closet <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_30">
                                 <label class="custom-control-label" for="checkbox_30">Lav faucet  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_31">
                                 <label class="custom-control-label" for="checkbox_31">Bath spout <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                        </div>
                         End View More - Collapse  
					 ...
					 <h4 class="font-size-14 mb-3 font-weight-bold article-title">Product Type  <i></i></h4>
                        ...
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              ...
                              <label class="custom-control-label" for="checkbox_32">Lav faucet  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_33">
                              <label class="custom-control-label" for="checkbox_33">Pipes and fittings <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_34">
                              <label class="custom-control-label" for="checkbox_34">Valve trim <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_35">
                              <label class="custom-control-label" for="checkbox_35">Bath spout  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_36">
                              <label class="custom-control-label" for="checkbox_36">Counter top basin   <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <!-- End Checkboxes -->
                        <!-- View More - Collapse -->
                        <div class="collapses6" id="collapseBrand1">
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 ...
                                 <label class="custom-control-label" for="checkbox_37">Rainhead <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_38">
                                 <label class="custom-control-label" for="checkbox_38">Showerhead <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_39">
                                 <label class="custom-control-label" for="checkbox_39">Shower arm <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                        </div>
                        <!-- End View More - Collapse -->
				...
				<article class="content-entry">
                        ...
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              ...
                              <label class="custom-control-label" for="checkbox_40">Valve trim  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_41">
                              <label class="custom-control-label" for="checkbox_41">P Trap  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_42">
                              <label class="custom-control-label" for="checkbox_42">Single flow  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_43">
                              <label class="custom-control-label" for="checkbox_43">S Trap <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_44">
                              <label class="custom-control-label" for="checkbox_44">Manual valve   <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <!-- End Checkboxes -->
                        <!-- View More - Collapse -->
                        <div class="collapses7" id="collapseBrand1">
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 ...
                                 <label class="custom-control-label" for="checkbox_45">Pipe  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_46">
                                 <label class="custom-control-label" for="checkbox_46">Coupler <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_47">
                                 <label class="custom-control-label" for="checkbox_47">Tee <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                        </div>
                        <!-- End View More - Collapse -->
			 ...
			 <h4 class="font-size-14 mb-3 font-weight-bold article-title">Shape<i></i></h4>
                        ...
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              ...
                              <label class="custom-control-label" for="checkbox_48">Square  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_49">
                              <label class="custom-control-label" for="checkbox_49">Round <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_50">
                              <label class="custom-control-label" for="checkbox_50">Oval  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_51">
                              <label class="custom-control-label" for="checkbox_51">Rectangle <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="checkbox_52">
                              <label class="custom-control-label" for="checkbox_52">Rectangular    <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                           </div>
                        </div>
                        <!-- End Checkboxes -->
                        <!-- View More - Collapse -->
                        <div class="collapses8" id="collapseBrand1">
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 ...
                                 <label class="custom-control-label" for="checkbox_53">Geometric  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_54">
                                 <label class="custom-control-label" for="checkbox_54">Organic  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_55">
                                 <label class="custom-control-label" for="checkbox_55">Rectengular  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_56">
                                 <label class="custom-control-label" for="checkbox_56">Geometric rectangular  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_57">
                                 <label class="custom-control-label" for="checkbox_57">Round & oval  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_58">
                                 <label class="custom-control-label" for="checkbox_58">Square soft edges  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                           <div class="form-group align-items-center justify-content-between mb-2 pb-1">
                              <div class="custom-control custom-checkbox">
                                 <input type="checkbox" class="custom-control-input" id="checkbox_60">
                                 <label class="custom-control-label" for="checkbox_60">Square  <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                              </div>
                           </div>
                        </div>
                        <!-- End View More - Collapse -->
 ...
 <div class="range-slider">
   <h4 class="font-size-14 mb-3 font-weight-bold">Price</h4>
	  <div class="mt-1 text-gray-111 d-flex mb-4"> 
         <div class="wrapper pro_range w-100 position-relative">
  <div class="values w-100 d-flow-root">
    <span id="range1" class="float-left slide_ranges_left" >   0 </span>
    <span id="range2" class="float-right"> 100 </span>
  </div>
  <div class="container1   position-absolute  mt-2 pt-1">
    <div class="slider-track"></div>
    <input type="range" min="0" max="10000" value="3000" id="slider-1" oninput="slideOne()">
    <input type="range" min="0" max="10000" value="6000" id="slider-2" oninput="slideTwo()">
  </div>
</div>
