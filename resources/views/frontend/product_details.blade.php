                  ...
                  <!--Last code end--->
                     <div class="d-block position-relative">
                        ...
                        <form id="option-choice-form" class="d-block w-100">
                           ...
                           <button class="out-of-stock background-gray mrgnlftnone btnneww_out">Out of stock</button>
                           ...
                           <button onclick="window.location.href='{{ route('bulkorder', $detailedProduct->slug) }}'" class="bulk-order-buttons bulkcartn mrgnlftnonebulk btnneww">Bulk Order</button>
                              ...
                              <a href="{{url('/more-seller/'.$detailedProduct->id)}}" ><button type="button" class="bulk-order-buttons bulkcartn moresellerw">More Sellers</button></a>
                           </div>
