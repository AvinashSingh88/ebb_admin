...
@section('content')
    ...
    <section class="pageTitle" style="background-image:url({{ url('assets/img/book-appointment.png')}});    height: 246px;">
                            ...
                            <div class="row">
                                                        ...
                                                        <div class="main-parenttttttT">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <textarea name="message"
                                                                    class="form-control textareas h-200 border-start-0"
                                ...
                                <div class="col-md-6 px-0">
                                    <div class="u-container-layout u-container-layout-2 h-100">
                                        <img src="{{ url('assets/img/get-appointments.png')}}" alt="" class="img-responsive w-100 h-100">
                                    </div>
                                </div>
                            </div>
