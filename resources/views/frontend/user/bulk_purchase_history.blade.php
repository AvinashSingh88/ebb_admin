                                                ...
                                                <div class="row border-bottom pb-2 mb-4">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                                        <div class="order_detail-btn">
                                                            ...
                                                            <a href="{{url('bulk-order-details/'.$order->id)}}" class="mt-1 order_btn text-capitalize ">
                                                                Order Detail
                                                            </a>
															{{--@if ($order->BulkorderDetails->first()->delivery_status == 'pending' && $order->payment_status == 'unpaid')
