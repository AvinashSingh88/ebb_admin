...
<div class=" w-100 mb-1 mys_accounts">
					...
					<form class="js-validate row" method="post" action="{{route('updateProfile')}}" enctype="multipart/form-data" novalidate="novalidate">
                        ...
                        <div class="hotel-form py-4 shadow-none">
						 ...
						 <div class="colampoxe mr-3  mx-0 px-0 py-2 shadow-none">
			  <div class="border-bottom1 border-color-111 mt-0 mb-3">
                                          <h3 class="section-title section-title__sm mb-0 pb-0 font-size-18 mt-0">Update your Profile</h3>
                                          <div class="deals">
                                             <hr class="mt-2">
                                          </div>
                                       </div>
                  ...
                  <div class="js-form-message form-group col-md-12 mb-3 floatprofile">  
                      ...
                      @endphp
                        ...
                        <li class="m-3 mt-0 mb-0">
                            <label for="genMale">
                                <input id="genMale" class="input-radio" type="radio" data-order_button_text="" value="Male" name="gender" {{$mcheck}} >
                                <span>Male </span>
                            </label> 
                        </li>
                        <li class="m-3 mt-0 mb-0">
                            <label for="genFemale">
                                <input type="radio" data-order_button_text="Proceed to PayPal" value="Female" name="gender" class="input-radio" {{$fcheck}} id="genFemale">
                                <span>Female  </span>
                            </label> 
                        </li>
                        <li class="m-3 mt-0 mb-0">
