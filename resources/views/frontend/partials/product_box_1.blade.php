...
<div class="product-box h-auto pb-3 product_data">
   ...
   <div class="discrptions">
      ...
      <h6>{{ home_discounted_base_price($product) }} &nbsp;@if($product->discount!=null)<strike>₹{{$product->unit_price}}</strike>@endif</h6>
   </div>
   <!-- <ul class="ulproducts">
                              <li>In stock</li>
							  ...
							  <div class="cart-add cart-add3 products_list ">
                                 <div class="input-group quantity_input mb-0">
                                     <div class="input-group w-auto justify-content-end align-items-center packageadd">
                                       ...
                                       <input type="button" value="&minus;" class="button-minus border rounded-circle quantity-left-minus icon-shape icon-sm mx-1 add_cart_button_plus" data-field="quantity">
                                       ...
                                       <input type="button" value="&plus;" class="button-plus border rounded-circle quantity-right-plus icon-shape icon-sm lh-0 add_cart_button_plus" data-field="quantity">
