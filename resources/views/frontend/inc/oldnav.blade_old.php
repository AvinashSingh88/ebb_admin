...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    ...
    <div class="custom_nav bg-white border-top border-gray-200 py-1">
        <div class="container">
            <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center" id>

             <!-- custom li category menu -->
           <li class="custom_category_nav h-100 d-flex align-items-center" id="category-menu-icon">
           <div class="dropdown-toggle navbar-light bg-light h-40px w-270px pl-2 rounded border c-pointer">
           <i class="fa fa-list-ul" style="color:#fff; "></i>             
           <!-- <span class="navbar-toggler-icon">
               
           </span> -->
           <span class="custom_ad pl-1 text-gray-90 fs-14 fw-600">All Departments</span>
        </div>
           </li>
