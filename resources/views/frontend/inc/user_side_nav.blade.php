<div class="both_holder sidkierls shadow-none">
    ...
    <div class="rhods mt-3">
	  ...
	  <p class="m-0 p-0 fs-7 fw-4"> My Account</p>
                                ...
                                <li class="{{ set_active('wishlists') }}"><a href="{{url('wishlists')}}"><i class="bg_icon-img"></i><span class="w-75">Wishlist</span> <span class="float-right background_box">0</span></a></li>
