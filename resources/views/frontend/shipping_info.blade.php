                ...
                @endphp
					...
					@csrf
                        ...
                        <div class="payments-options p-4 pt-0">
                            ...
                            <button type="submit" class="placeholder-buttonsl w-100 btn-success mt-3">Cash On Delivery (COD)</button>
							
                        </div>
					</form>
						<div class="payments-options p-4 pt-0">
                            
                            <button class="placeholder-buttonsl w-100 btn-danger mt-4">Pay Now</button>
                        </div>
