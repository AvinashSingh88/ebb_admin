...
@section('title')Building Material Supply  @endsection
          ...
          <div class="row">
            ...
            <form class="bottom-form_contact " method="post" action="addinteriorformdata">
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="form_type" value="building_page">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="content_row row">
            ...
            <div class="col-md-12">
              <div class="clm_66">
                <div class="aboutIfo">
                  <div class="border-bottom1 border-color-111 mt-0 mb-3">
                    <h2>Material <strong> Expertise</strong></h2>
                    <div class="deals">
                      <hr />
                    </div>
                  </div>
      ...
      <div class="container">
        ...
        <div class="row photos my-3">
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="./img/pros8.png" data-lightbox="photos" class="lb_all-link">
              <img class="img-fluid" src="{{ url('assets/img/pros8.png')}}"/>
            </a>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3 item">
            <a href="./img/pros8.png" data-lightbox="photos" class="lb_all-link">
