...
class ServiceSearchController extends Controller
{
    ...
    public function index(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        return view('frontend.service_listing', compact('first_five_color','categories','products', 'query', 'category_id', 'brand_id', 'sort_by', 'seller_id','min_price', 'max_price', 'attributes', 'selected_attribute_values', 'colors', 'selected_color'));
    }
