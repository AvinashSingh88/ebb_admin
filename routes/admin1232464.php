...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/languages/update-status', 'LanguageController@update_status')->name('languages.update-status');
