		 ...
		 function showCountdown() {
		     ...
		     if (fecha != '') {
		         ...
		         var x = setInterval(function() {
		             ...
		             document.getElementById("Days").innerHTML = "<span class='box'>" + days + "</span><small></small> ";
		             document.getElementById("Hours").innerHTML = "<span class='box'>" + hours + "</span><small>H</small> ";
		             document.getElementById("Minutes").innerHTML = "<span class='box'>" + minutes + "</span><small>M</small> ";
		             document.getElementById("Seconds").innerHTML = "<span class='box'>" + seconds + "</span><small>S</small> ";
		 ...
		 //      var endTime = new Date("30 December 2022 9:56:00 GMT+01:00");
		 ...
		 jQuery(document).ready(function() {
		     ...
		     if (jQuery('.our-work-search-container').length > 0) {
		         ...
		         /*jQuery(document).on('click','.our-work-item',function(e){
		         	 e.preventDefault();
		         	// window.history.pushState( 'our-work-popup-opened' , null, jQuery(this).data('url'));
		         	jQuery.magnificPopup.open({
		         	  	items: {
		         	  		src:jQuery(this).find('.video').clone() 
		         	  	},
		         	  	type: 'inline',
		         		callbacks: {
		         			open: function() {
		         		      ...
		         		      // console.log(jQuery('.mfp-content .player').data('video'));
		         		      // jQuery('.mfp-content .video').data('video').play();
		         		      console.log(new Plyr('.mfp-content .video .player',{
		         		      	autoplay:true
		         		      })); 
		         		    },
		         		    close: function() {
