                              ...
                              <li class="shop">
                                 ...
                                 <div class="top_ul">
                                    <ul class="departmentdks">
                                       ...
                                       <li class="sanitaryware1a">
                                          <a href="javascript:void(0);"><span class="img000"><img src="img/icona9.png" alt="" /></span>
                                          <span class="spand-line">Paints & Surface Care   <i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                                          <div class="top-megamenu web-mega sanitarywarea1">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-8" style="padding-right: 0px">
                                                      <ul class="megamenusubs">
                                                         <li>
                                                            <b class="webhead1"> Architect</b>
                                                            <ul class="megamenusubs231 megamenusubs231a">
                                                               <li>
                                                                  <a><img src="img/menu1.png" alt=""> Angular
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu6.png" alt=""> NodeJS
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu3.png" alt=""> PHP
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu4.png" alt=""> Laravel
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt=""> Cake PHP</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu6.png" alt=""> Python
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu1.png" alt=""> Symfony
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt=""> ReactJS
                                                                  </a>
                                                               </li>
                                                            </ul>
                                                         </li>
                                                         <li>
                                                            ...
                                                            <ul class="megamenusubs231 megamenusubs231b">
                                                               <li>
                                                                  <a><img src="img/menu1.png" alt="">
                                                                  IOS App</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt="">
                                                                  Android App
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu3.png" alt="">
                                                                  Ionic App
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu4.png" alt="">
                                                                  iBeacon App
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu5.png" alt="">
                                                                  Wearable App
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu6.png" alt="">
                                                                  IoT App
                                                                  </a>
                                                               </li>
                                                               <li>
                                                               ...
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt=""> AR
                                                                  &amp; VR App
                                                                  </a>
                                                               </li>
                                                            </ul>
                                                         ...
                                                         <li>
                                                            <b class="webhead3">Services Engineer</b>
                                                         ...
                                                         <li>
                                                            <b class="webhead4">Structural Engineer </b>
                                                            <ul class="megamenusubs231 megamenusubs231d">
                                                               <li>
                                                                  <a><img src="img/menu1.png" alt=""> WordPress
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt=""> Magento
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu3.png" alt=""> Shopify
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu4.png" alt=""> WooCommerce
                                                                  </a>
                                                               </li>
                                                            </ul>
                                                         </li>
                                                         <li>
                                                            <b class="webhead5">Interior Designer</b>
                                                            <ul class="megamenusubs231 megamenusubs231e">
                                                               <li>
                                                                  <a><img src="img/menu1.png" alt=""> Social Media Marketing</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt=""> PPC Marketing</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu3.png" alt=""> Brand Management</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu4.png" alt=""> Mobile App Marketing</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu5.png" alt=""> Search Engine Optimisation
                                                                  </a>
                                                               </li>
                                                            </ul>
                                                         </li>
                                                         <li>
                                                            <b class="webhead6">Vastu / Archaeologist</b>
                                                            <ul class="megamenusubs231 megamenusubs231f">
                                                               <li>
                                                                  <a><img src="img/menu1.png" alt=""> WordPress Plugin
                                                                  </a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu2.png" alt=""> Magento Extension</a>
                                                               </li>
                                                               <li>
                                                                  <a><img src="img/menu3.png" alt=""> Vtiger Extension</a>
                                                               </li>
                                                            </ul>
                                                         </li>
                                                      </ul>
                                                ...
                                                <div class="col-md-8" style="padding-right: 0px">
                                                   <ul class="megamenusubs">
                                                      ...
                                                      <li>
                                                         ...
                                                         <ul class="megamenusubs231 megamenusubs231d">
                                                            <li>
                                                               <a><img src="img/brickm.png" alt=""> Bricks Fly Ash
                                                               </a>
                                                            </li>
                                                            <li>
                                                               <a><img src="img/brickm.png" alt=""> Red Brick
                                                               </a>
                                                            </li>
                                                            <li>
                                                               <a><img src="img/brickm.png" alt=""> Machine made Bricks
                                                               </a>
                                                            </li>
                                                            <li>
                                                               <a href="#gory.php" class="buildsing">  View More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
...
 </a>
                                                ...
                                                <div class="col-md-8" style="padding-right: 0px">
                                                   <ul class="megamenusubs">
                                                      ...
                                                      <li>
                                                         ...
                                                         <ul class="megamenusubs231 megamenusubs231d">
                                                            <li>
                                                               <a><img src="img/brickm.png" alt=""> kitchen cabinets
                                                               </a>
                                                            </li>
                                                            <li>
                                                               <a><img src="img/brickm.png" alt=""> kitchen trolleys
                                                               </a>
                                                            </li>
                                                            <li>
                                                               <a><img src="img/brickm.png" alt=""> kitchen furniture
                                                               </a>
                                                            </li>
                                                            <li>
                                                               <a href="#gory.php" class="buildsing">  View More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                       ...
                                       <div class="top-megamenu web-mega steels1">
                                          <!-- mega menu content start here -->
                                          <div class="megamenu megamenu2" style="background: center top rgb(255, 255, 255); display:block ; opacity:1;">
                                            <div class="row">
                                                <div class="col-md-8" style="padding-right: 0px">
                                       ...
                                       <div class="top-megamenu web-mega windos1">
                                          <!-- mega menu content start here -->
                                          <div class="megamenu megamenu2" style="background: center top rgb(255, 255, 255); display:block ; opacity:1;">
                                            <div class="row">
                                                <div class="col-md-8" style="padding-right: 0px">
                                       ...
                                       <div class="top-megamenu web-mega tools1">
                                          <!-- mega menu content start here -->
                                          <div class="megamenu megamenu2" style="background: center top rgb(255, 255, 255); display:block ; opacity:1;">
                                            <div class="row">
                                                <div class="col-md-8" style="padding-right: 0px">
                                       ...
                                       <div class="top-megamenu web-mega sanitaryware1a">
                                          <!-- mega menu content start here -->
                                          <div class="megamenu megamenu2" style="background: center top rgb(255, 255, 255); display:block ; opacity:1;">
                                           <div class="row">
                                                <div class="col-md-8" style="padding-right: 0px">
                                    ...
                                    <ul>
                                       <li>
                                          <div class="sub-menu-item">
                                             <a href="javascript:void(0);" class="ProductLink">
                                       ...
                                       <li>
                                          <div class="sub-menu-item">
                                             <a href="javascript:void(0);" class="ProductLink">
                                                ...
                                                <h3>End to End Consulants </h3>
                                             </a>
                                             <ol>
                                                <li>
                                                   <a href="javascript:void(0);"> Consultation and investigation </a>
                                                </li>
                                                <li>
                                                   <a href="javascript:void(0);"> Drafting and design</a>
                                                </li>
                                                <li>
                                                   <a href="javascript:void(0);"> Construction management </a>
                                                </li>
                                                <li>
                                                   <a href="javascript:void(0);"> Forensic engineering </a>
                                                </li>
                                             </ol>
                                          </div>
                                       </li>
