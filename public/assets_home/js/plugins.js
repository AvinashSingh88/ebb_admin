...
(function (t) {
	...
	t(document).on("mouseup", function () {
		...
		_create: function () {
			...
			}), this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i) && (this.element.wrap(t("<div class='ui-wrapper' style='overflow: visible;'></div>").css({
		...
		_renderProxy: function () {
			var e = this.element,
				i = this.options;
			this.elementOffset = e.offset(), this._helper ? (this.helper = this.helper || t("<div style='overflow:visible;'></div>"), this._addClass(this.helper, this._helper), this.helper.css({
				width: this.element.outerWidth(),
				height: this.element.outerHeight(),
				position: "absolute",
	...
	t.ui.ddmanager = {
			...
			s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
				element: function () {
					var s = e.currentItem[0].nodeName.toLowerCase(),
						n = t("<" + s + ">", e.document[0]);
					return e._addClass(n, "ui-sortable-placeholder", i || e.currentItem[0].className)._removeClass(n, "ui-sortable-helper"), "tbody" === s ? e._createTrPlaceholder(e.currentItem.find("tr").eq(0), t("<tr>", e.document[0]).appendTo(n)) : "tr" === s ? e._createTrPlaceholder(e.currentItem, n) : "img" === s && n.attr("src", e.currentItem.attr("src")), i || n.css("visibility", "visible"), n
				},
				update: function (t, n) {
		...
		_open: function (e, i, s) {
			function n(t) {
				l.of = t, a.is(":visible") || a.position(l)
			}
...
function (a, b, c, d) {
	...
	e.Defaults = {
		...
		return this._timeout && b.clearTimeout(this._timeout), b.setTimeout(a.proxy(function () {
			this._paused || this._core.is("busy") || this._core.is("interacting") || c.visible || this._core.next(e || this._core.settings.autoplaySpeed)
	...
	b = function () {
		function c(c, d) {
			...
			e.defaults = {
				...
				transformsEnabled: !1,
				unslicked: !1
			}, a.extend(e, e.initials), e.activeBreakpoint = null, e.animType = null, e.animProp = null, e.breakpoints = [], e.breakpointSettings = [], e.cssTransitions = !1, e.focussed = !1, e.interrupted = !1, e.visible = "visible", e.paused = !0, e.positionProp = null, e.respondTo = null, e.rowCount = 1, e.shouldClick = !0, e.$slider = a(c), e.$slidesCache = null, e.transformType = null, e.transitionType = null, e.visibilityChange = "visibilitychange", e.windowWidth = 0, e.windowTimer = null, f = a(c).data("slick") || {}, e.options = a.extend({}, e.defaults, d, f), e.currentSlide = e.options.initialSlide, e.originalSettings = e.options, "undefined" != typeof document.mozHidden ? (e.visible = "mozHidden", e.visibilityChange = "mozvisibilitychange") : "undefined" != typeof document.webkitHidden && (e.visible = "webkitHidden", e.visibilityChange = "webkitvisibilitychange"), e.autoPlay = a.proxy(e.autoPlay, e), e.autoPlayClear = a.proxy(e.autoPlayClear, e), e.autoPlayIterator = a.proxy(e.autoPlayIterator, e), e.changeSlide = a.proxy(e.changeSlide, e), e.clickHandler = a.proxy(e.clickHandler, e), e.selectHandler = a.proxy(e.selectHandler, e), e.setPosition = a.proxy(e.setPosition, e), e.swipeHandler = a.proxy(e.swipeHandler, e), e.dragHandler = a.proxy(e.dragHandler, e), e.keyHandler = a.proxy(e.keyHandler, e), e.instanceUid = b++, e.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/, e.registerBreakpoints(), e.init(!0)
		}
		var b = 0;
		return c
		...
		var c, d, e, f, b = this;
		d = b.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-visible", "true"), b.$slides.eq(a).addClass("slick-current"), b.options.centerMode === !0 ? (c = Math.floor(b.options.slidesToShow / 2), b.options.infinite === !0 && (a >= c && a <= b.slideCount - 1 - c ? b.$slides.slice(a - c, a + c + 1).addClass("slick-active").attr("aria-visible", "false") : (e = b.options.slidesToShow + a, d.slice(e - c + 1, e + c + 2).addClass("slick-active").attr("aria-visible", "false")), 0 === a ? d.eq(d.length - 1 - b.options.slidesToShow).addClass("slick-center") : a === b.slideCount - 1 && d.eq(b.options.slidesToShow).addClass("slick-center")), b.$slides.eq(a).addClass("slick-center")) : a >= 0 && a <= b.slideCount - b.options.slidesToShow ? b.$slides.slice(a, a + b.options.slidesToShow).addClass("slick-active").attr("aria-visible", "false") : d.length <= b.options.slidesToShow ? d.addClass("slick-active").attr("aria-visible", "false") : (f = b.slideCount % b.options.slidesToShow, e = b.options.infinite === !0 ? b.options.slidesToShow + a : a, b.options.slidesToShow == b.options.slidesToScroll && b.slideCount - a < b.options.slidesToShow ? d.slice(e - (b.options.slidesToShow - f), e + f).addClass("slick-active").attr("aria-visible", "false") : d.slice(e, e + b.options.slidesToShow).addClass("slick-active").attr("aria-visible", "false")), "ondemand" === b.options.lazyLoad && b.lazyLoad()
		...
		var b = this;
		a(".slick-cloned", b.$slider).remove(), b.$dots && b.$dots.remove(), b.$prevArrow && b.htmlExpr.test(b.options.prevArrow) && b.$prevArrow.remove(), b.$nextArrow && b.htmlExpr.test(b.options.nextArrow) && b.$nextArrow.remove(), b.$slides.removeClass("slick-slide slick-active slick-visible slick-current").attr("aria-visible", "true").css("width", "")
		...
		var a = this;
		null !== a.$dots && (a.$dots.find("li").removeClass("slick-active").attr("aria-visible", "true"), a.$dots.find("li").eq(Math.floor(a.currentSlide / a.options.slidesToScroll)).addClass("slick-active").attr("aria-visible", "false"))
	}, b.prototype.visibility = function () {
		var a = this;
		a.options.autoplay && (document[a.visible] ? a.interrupted = !0 : a.interrupted = !1)
	}, a.fn.slick = function () {
		var f, g, a = this,
			c = arguments[0],
	...
	e.fn.fullpage = function (l) {
		...
		function Se() {
			St.css({
				height: "100%",
				position: "relative"
			}), St.addClass(a), e("html").addClass(), yt = ne.height(), St.removeClass(f), Ce(), e(y).each(function (n) {
				var t = e(this),
					o = t.find(z),
					i = o.length;
...
$(function () {
	"use strict";
	$(".toggle-news-content-1").on("click", function () {
		$(".panel-left-1, .panel-right-1").hasClass("open") ? ($(".panel-left-1, .panel-right-1").removeClass("open"), $(".panel-left-1, .panel-right-1").addClass("close")) : ($(".panel-left-1, .panel-right-1").removeClass("close"), $(".panel-left-1, .panel-right-1").addClass("open"))
	}), $(".toggle-news-content-2").on("click", function () {
		$(".panel-left-2, .panel-right-2").hasClass("open") ? ($(".panel-left-2, .panel-right-2").removeClass("open"), $(".panel-left-2, .panel-right-2").addClass("close")) : ($(".panel-left-2, .panel-right-2").removeClass("close"), $(".panel-left-2, .panel-right-2").addClass("open"))
	}), $(".toggle-news-content-3").on("click", function () {
		$(".panel-left-3, .panel-right-3").hasClass("open") ? ($(".panel-left-3, .panel-right-3").removeClass("open"), $(".panel-left-3, .panel-right-3").addClass("close")) : ($(".panel-left-3, .panel-right-3").removeClass("close"), $(".panel-left-3, .panel-right-3").addClass("open"))
	}), $(".toggle-news-content-4").on("click", function () {
		$(".panel-left-4, .panel-right-4").hasClass("open") ? ($(".panel-left-4, .panel-right-4").removeClass("open"), $(".panel-left-4, .panel-right-4").addClass("close")) : ($(".panel-left-4, .panel-right-4").removeClass("close"), $(".panel-left-4, .panel-right-4").addClass("open"))
	})
});
! function (e, t) {
		...
		$.each(n, function (n, e) {
			...
			var r = $(e),
				...
				t = new ScrollMagic.Scene({
					...
					duration: i,
					offset: -110
				}).setClassToggle(".logo", "logo-dark").addTo(o).on("enter", function (o) {
					$(".logo").addClass("logo-dark"), $(".main-menu").addClass("main-menu-dark")
				}).on("leave", function (o) {
					$(".logo").removeClass("logo-dark"), $(".main-menu").removeClass("main-menu-dark")
				});
		...
		$.each(n, function (n, e) {
			...
			var r = $(e),
				...
				t = new ScrollMagic.Scene({
					...
					$(".logo").removeClass("logo-light"), $(".main-menu").addClass("main-menu-dark")
				}).on("leave", function (o) {
					$(".logo").addClass("logo-light"), $(".main-menu").removeClass("main-menu-dark")
				});
			$(window).on("resize", function () {
				t.duration(a(r))
			})
