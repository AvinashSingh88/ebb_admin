	...
	488: function (e, t, n) {
		...
		var D = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
			...
			q = function (e) {
				function t(e) {
					var n, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
					return a(this, t), n = p(this, g(t).call(this)), D && P.call(f(n)), C(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, f(n)), n.options = o, void 0 === n.options.keySeparator && (n.options.keySeparator = "."), n.logger = L.create("translator"), n
				}
				return d(t, e), u(t, [{
					key: "changeLanguage",
					value: function (e) {
					...
					value: function (e, t) {
						...
						if (k && h && x && m.indexOf(y) < 0 && ("string" != typeof b || "[object Array]" !== y)) {
							if (!t.returnObjects && !this.options.returnObjects) return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(d, h, t) : "key '".concat(s, " (").concat(this.language, ")' returned an object instead of string.");
							if (r) {
							...
							if (j || R || N) {
								...
								var A = function (e, o) {
									n.options.missingKeyHandler ? n.options.missingKeyHandler(e, l, o, N ? t.defaultValue : h, N, t) : n.backendConnector && n.backendConnector.saveMissing && n.backendConnector.saveMissing(e, l, o, N ? t.defaultValue : h, N, t), n.emit("missingKey", e, l, o, h)
								};
								if (this.options.saveMissing) {
									var I = void 0 !== t.count && "string" != typeof t.count;
									this.options.saveMissingPlurals && I ? E.forEach((function (e) {
							...
							h = this.extendTranslation(h, e, t, g), j && h === s && this.options.appendNamespaceToMissingKey && (h = "".concat(l, ":").concat(s)), j && this.options.parseMissingKeyHandler && (h = this.options.parseMissingKeyHandler(h))
						}
						return h
					}
				}, {
					...
					value: function (e, t, n, o) {
						...
						return null != e && u && u.length && !1 !== n.applyPostProcessor && (e = V.handle(u, e, t, this.options && this.options.postProcessPassResolved ? i({
							i18nResolved: o
						}, n) : n, this)), e
					}
				}, {
						...
						return "string" == typeof e && (e = [e]), e.forEach((function (e) {
							if (!a.isValidLookup(t)) {
								...
								c.forEach((function (e) {
									a.isValidLookup(t) || (i = e, !_["".concat(g[0], "-").concat(e)] && a.utils && a.utils.hasLoadedNamespace && !a.utils.hasLoadedNamespace(i) && (_["".concat(g[0], "-").concat(e)] = !0, a.logger.warn('key "'.concat(n, '" for namespace "').concat(i, '" for languages "').concat(g.join(", "), "\" won't get resolved as namespace was not yet loaded"), "This means something IS WRONG in your application setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), g.forEach((function (n) {
										if (!a.isValidLookup(t)) {
											r = n;
											var i, u, c = l,
												g = [c];
		...
		var X = function () {
			...
			J = function () {
				function e() {
					...
					a(this, e), this.logger = L.create("interpolator"), this.options = t, this.format = t.interpolation && t.interpolation.format || function (e) {
						return e
					}, this.init(t)
				}
				return u(e, [{
					...
					value: function (e, t) {
						...
						for (s.applyPostProcessor = !1, delete s.defaultValue; n = this.nestingRegexp.exec(e);) {
							...
							"string" != typeof o && (o = j(o)), o || (this.logger.warn("missed to resolve ".concat(n[1], " for nesting ").concat(e)), o = ""), c && (o = l.reduce((function (e, t) {
		...
		var G = function (e) {
			function t(e, n, o) {
				...
				return a(this, t), r = p(this, g(t).call(this)), D && P.call(f(r)), r.backend = e, r.store = n, r.services = o, r.languageUtils = o.languageUtils, r.options = i, r.logger = L.create("backendConnector"), r.state = {}, r.queue = [], r.backend && r.backend.init && r.backend.init(o, i.backend, i), r
			}
			return d(t, e), u(t, [{
				key: "queueLoad",
				value: function (e, t, n, o) {
					...
					return e.forEach((function (e) {
						...
						t.forEach((function (t) {
							...
							!n.reload && r.store.hasResourceBundle(e, t) ? r.state[s] = 2 : r.state[s] < 0 || (1 === r.state[s] ? a.indexOf(s) < 0 && a.push(s) : (r.state[s] = 1, o = !1, a.indexOf(s) < 0 && a.push(s), i.indexOf(s) < 0 && i.push(s), u.indexOf(t) < 0 && u.push(t)))
						})), o || s.push(e)
				...
				value: function (e, t, n) {
					...
					this.queue.forEach((function (n) {
						var o, s, u, l, c, f;
						o = n.loaded, s = i, l = N(o, [r], Object), c = l.obj, f = l.k, c[f] = c[f] || [], u && (c[f] = c[f].concat(s)), u || c[f].push(s),
							function (e, t) {
				...
				value: function (e) {
					...
					this.read(i, a, "read", void 0, void 0, (function (o, r) {
						o && t.logger.warn("".concat(n, "loading namespace ").concat(a, " for language ").concat(i, " failed"), o), !o && r && t.logger.log("".concat(n, "loaded namespace ").concat(a, " for language ").concat(i), r), t.loaded(e, o, r)
					}))
				}
			}, {
				key: "saveMissing",
		...
		var ee = new(function (e) {
				function t() {
					...
					if (a(this, t), e = p(this, g(t).call(this)), D && P.call(f(e)), e.options = Q(n), e.services = {}, e.logger = L, e.modules = {
							external: []
				...
				return d(t, e), u(t, [{
					...
					value: function () {
						...
						if ("function" == typeof t && (n = t, t = {}), this.options = i({}, Y(), this.options, Q(t)), this.format = this.options.interpolation.format, n || (n = Z), !this.options.isClone) {
							...
							var a = this.services;
							a.logger = L, a.resourceStore = this.store, a.languageUtils = r, a.pluralResolver = new X(r, {
								prepend: this.options.pluralSeparator,
								compatibilityJSON: this.options.compatibilityJSON,
								simplifyPluralSuffix: this.options.simplifyPluralSuffix
							}), a.interpolator = new J(this.options), a.utils = {
								hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
							}, a.backendConnector = new G(o(this.modules.backend), a.resourceStore, a, this.options), a.backendConnector.on("*", (function (t) {
					...
					value: function (e, t, n) {
						var o = R();
						return e || (e = this.languages), t || (t = this.options.ns), n || (n = Z), this.services.backendConnector.reload(e, t, (function (e) {
							o.resolve(), n(e)
						})), o
					}
				}, {
					...
					value: function (e) {
						...
						return "backend" === e.type && (this.modules.backend = e), ("logger" === e.type || e.log && e.warn && e.error) && (this.modules.logger = e), "languageDetector" === e.type && (this.modules.languageDetector = e), "i18nFormat" === e.type && (this.modules.i18nFormat = e), "postProcessor" === e.type && V.addPostProcessor(e), "3rdParty" === e.type && this.modules.external.push(e), this
					}
				}, {
					key: "changeLanguage",
					value: function (e, t) {
		...
		function re(e) {
			return ne.call(oe.call(arguments, 1), (function (t) {
				if (t)
		...
		var je = function () {
			...
			return u(e, [{
				...
				value: function (e) {
					...
					this.services = e, this.options = ge(t, this.options || {}, {
					...
					}), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(be), this.addDetector(ke), this.addDetector(we), this.addDetector(Se), this.addDetector(Oe), this.addDetector(Le), this.addDetector(Pe), this.addDetector(Re)
				}
			}, {
				key: "addDetector",
				value: function (e) {
